...
public class DefaultController {
	...
	@GetMapping({"","/","/home"})
	public ModelAndView defaultGetRequestHandlar() {
		ModelAndView mv = new ModelAndView();
		
		mv.setViewName("home");
		mv.addObject("pageTitle","Home Page-Welcome All");
		mv.addObject("developers",new String[] {"meghana","sweety","Srili"});
		 return mv;
		 
	}
	@RequestMapping("/header")public ModelAndView getHeaderPage() {
	...
	public ModelAndView sayHello(
			...
			@RequestParam(name="meghana",required=false,defaultValue="somebody") String userName) {
